...
tools: [vscode/getProjectSetupInfo, vscode/memory, vscode/newWorkspace, vscode/runCommand, vscode/vscodeAPI, vscode/askQuestions, execute/runNotebookCell, execute/testFailure, execute/getTerminalOutput, execute/runInTerminal, execute/runTests, read/getNotebookSummary, read/problems, read/readFile, read/readNotebookCellOutput, read/terminalSelection, read/terminalLastCommand, agent/runSubagent, edit/createFile, edit/editFiles, edit/rename, search/changes, search/codebase, search/fileSearch, search/listDirectory, search/searchResults, search/textSearch, search/usages, web/fetch, actor-critic-thinking/actor-critic-thinking, arxiv-mcp-improved/batch_download_and_convert, arxiv-mcp-improved/download_and_convert_paper_tool, arxiv-mcp-improved/extract_citations, arxiv-mcp-improved/fetch_arxiv_paper_content, arxiv-mcp-improved/search_arxiv, memory-mcp/add_observations, memory-mcp/create_entities, memory-mcp/create_relations, memory-mcp/delete_entities, memory-mcp/delete_observations, memory-mcp/delete_relations, memory-mcp/open_nodes, memory-mcp/read_graph, memory-mcp/search_nodes, sequentialthinking/sequentialthinking, github/search_code, github/search_repositories, vscode.mermaid-chat-features/renderMermaidDiagram, mermaidchart.vscode-mermaid-chart/get_syntax_docs, mermaidchart.vscode-mermaid-chart/mermaid-diagram-validator, mermaidchart.vscode-mermaid-chart/mermaid-diagram-preview, ms-vscode.vscode-websearchforcopilot/websearch, todo]
agents: ["*"]
---
...
- You MUST cross-reference findings across multiple authoritative sources to validate accuracy. This sources shall be looked for in the codebase, official documentation, and reputable external references, especially academic articles (such as in arxiv) and industry best practices. #tool:web for fetching and #tool:ms-vscode.vscode-websearchforcopilot/websearch for searching (or your own websearch tool, but bring the references URLs utilized).
