...
tools: [vscode/memory, vscode/resolveMemoryFileUri, vscode/vscodeAPI, vscode/askQuestions, execute/executionSubagent, execute/getTerminalOutput, execute/killTerminal, execute/sendToTerminal, execute/runInTerminal, read, agent, edit, search, github/search_code, github/search_issues, github/search_pull_requests, github/search_repositories, github/search_users, 'obsidian/*', filesystem/read_multiple_files, 'sequentialthinking/*', browser, ms-vscode.vscode-websearchforcopilot/websearch, todo]
---
