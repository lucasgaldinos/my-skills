...
tools: [vscode/getProjectSetupInfo, vscode/memory, vscode/resolveMemoryFileUri, vscode/runCommand, vscode/vscodeAPI, vscode/extensions, vscode/askQuestions, execute/getTerminalOutput, execute/awaitTerminal, execute/killTerminal, execute/runInTerminal, execute/runTests, read/problems, read/readFile, read/viewImage, read/terminalSelection, read/terminalLastCommand, agent, edit/createDirectory, edit/createFile, edit/editFiles, edit/rename, search, web, github/get_commit, github/list_commits, github/request_copilot_review, github/search_code, github/search_issues, github/search_pull_requests, github/search_repositories, github/search_users, 'actor-critic-thinking/*', filesystem/read_multiple_files, github/get_commit, github/list_commits, github/request_copilot_review, github/search_code, github/search_issues, github/search_pull_requests, github/search_repositories, github/search_users, browser/openBrowserPage, vscode.mermaid-chat-features/renderMermaidDiagram, mermaidchart.vscode-mermaid-chart/get_syntax_docs, mermaidchart.vscode-mermaid-chart/mermaid-diagram-validator, mermaidchart.vscode-mermaid-chart/mermaid-diagram-preview, ms-vscode.vscode-websearchforcopilot/websearch, todo]
agents: []
---
...
- Be consultative: #tool:vscode/askQuestions to understand needs
...
- [vscode custom agent documentation](https://code.visualstudio.com/docs/copilot/customization/custom-agents)
- [subagents](https://code.visualstudio.com/docs/copilot/agents/subagents)

  subagents must be spawned with #tool:agent/runSubagent. You won't be spawning them directly.

### Github Copilot

- [copilot custom agent](https://docs.github.com/en/copilot/how-tos/use-copilot-agents/coding-agent/create-custom-agents)
- [test custom agent](https://docs.github.com/en/copilot/how-tos/use-copilot-agents/coding-agent/test-custom-agents)
- [subagents](./references/vscode-subagents.md)

### Copilot CLI

- [using custom agents](https://docs.github.com/en/copilot/how-tos/copilot-cli/use-copilot-cli-agents/overview#use-custom-agents)

### Best practices for agents

- [Reduce hallucinations](./references/reduce-hallucination.md)
- [Increase output consistency](./references/increase-output-consistency.md)
