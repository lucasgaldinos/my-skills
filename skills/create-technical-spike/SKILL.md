...
description: |
  Use this skill when scoping or documenting a technical research spike. Triggers on: "create a spike document", "I need to research X before we build it", "write a technical spike for Y", "we need to investigate Z", "create a time-boxed research task", "document this technical unknown", "scope out a spike for this decision". Produces a structured spike document with a clear research question, investigation plan, success criteria, and space for findings and a recommendation — so the spike has a defined end state and doesn't drift.
argument-hint: "[spike topic or technical question to investigate]"
user-invocable: true
---
