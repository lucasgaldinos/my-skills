...
description: 'Use this skill when asked to create, generate, or draw diagrams using Excalidraw. Triggers on: "create a diagram", "make a flowchart", "visualize a process", "draw a system architecture", "create a mind map", "generate an Excalidraw file", "diagram this workflow", "show the relationship between", "draw a sequence diagram". Supports flowcharts, relationship diagrams, mind maps, system architecture, ER diagrams, class diagrams, and sequence diagrams. Outputs .excalidraw JSON files that open directly in Excalidraw.'
argument-hint: "[diagram type and description of what to visualize]"
user-invocable: true
---
