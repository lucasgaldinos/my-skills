---
name: refactor
description: 'Use this skill for surgical code refactoring to improve maintainability without changing behavior. Triggers on: "clean up this code", "refactor this", "this function is too long", "extract this logic", "improve readability", "fix code smells", "rename this variable", "break down this class", "apply design patterns here". Covers extracting functions, renaming, breaking down god functions, improving type safety, eliminating code smells, and applying patterns. Less drastic than a full rewrite — use for gradual, behavior-preserving improvements.'
argument-hint: "[file path or code snippet to refactor, and specific goal if known]"
user-invocable: true
license: MIT
---
