...
description: |
  Use this skill when analyzing a codebase to produce or update architectural documentation. Triggers on: "document our architecture", "create an architecture blueprint", "generate architecture docs", "analyze our project structure", "create architectural decision records", "document how this system is organized", "generate a C4 diagram", "map out our layers and dependencies". Produces a comprehensive Project_Architecture_Blueprint.md covering technology stack, layers, patterns, cross-cutting concerns, data architecture, and extension guidance.
argument-hint: "[repository path or codebase context; optional: diagram type (C4/UML/Flow), detail level (High-level/Comprehensive)]"
user-invocable: true
---
