:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: {#pandocs-markdown .section .level1}
# [](#pandocs-markdown){.anchor aria-hidden="true"}Pandoc's Markdown
...
::: {#philosophy .section .level2}
## [](#philosophy){.anchor aria-hidden="true"}Philosophy
...
:::: {#paragraphs .section .level2}
## [](#paragraphs){.anchor aria-hidden="true"}Paragraphs
...
::: {#extension-escaped_line_breaks .section .level3}
### [](#extension-escaped_line_breaks){.anchor aria-hidden="true"}Extension: `escaped_line_breaks` [±]{.extension-checkbox aria-hidden="true" title="part of commonmark
...
:::::::::: {#headings .section .level2}
## [](#headings){.anchor aria-hidden="true"}Headings

There are two kinds of headings: Setext and ATX.

::: {#setext-style-headings .section .level3}
### [](#setext-style-headings){.anchor aria-hidden="true"}Setext-style headings
...
::: {#atx-style-headings .section .level3}
### [](#atx-style-headings){.anchor aria-hidden="true"}ATX-style headings
...
::: {#extension-blank_before_header .section .level3}
### [](#extension-blank_before_header){.anchor aria-hidden="true"}Extension: `blank_before_header` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
      + plain
...
::: {#extension-space_in_atx_header .section .level3}
### [](#extension-space_in_atx_header){.anchor aria-hidden="true"}Extension: `space_in_atx_header` [±]{.extension-checkbox aria-hidden="true" title="part of commonmark
...
::: {#heading-identifiers .section .level3}
### [](#heading-identifiers){.anchor aria-hidden="true"}Heading identifiers

See also the [`auto_identifiers` extension](#extension-auto_identifiers) above.
:::

::: {#extension-header_attributes .section .level3}
### [](#extension-header_attributes){.anchor aria-hidden="true"}Extension: `header_attributes` [±]{.extension-checkbox aria-hidden="true" title="available in commonmark
...
Headings with the class `unnumbered` will not be numbered, even if [`--number-sections`](#option--number-sections){.option} is specified. A single hyphen (`-`) in an attribute context is equivalent to `.unnumbered`, and preferable in non-English documents. So,
...
::: {#extension-implicit_header_references .section .level3}
### [](#extension-implicit_header_references){.anchor aria-hidden="true"}Extension: `implicit_header_references` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + markdown
      + markdown_mmd
      + opml
...
## [](#block-quotations){.anchor aria-hidden="true"}Block quotations
...
::: {#extension-blank_before_blockquote .section .level3}
### [](#extension-blank_before_blockquote){.anchor aria-hidden="true"}Extension: `blank_before_blockquote` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
      + plain
...
:::::::: {#verbatim-code-blocks .section .level2}
## [](#verbatim-code-blocks){.anchor aria-hidden="true"}Verbatim (code) blocks

::: {#indented-code-blocks .section .level3}
### [](#indented-code-blocks){.anchor aria-hidden="true"}Indented code blocks
...
::: {#fenced-code-blocks .section .level3}
### [](#fenced-code-blocks){.anchor aria-hidden="true"}Fenced code blocks
:::

::: {#extension-fenced_code_blocks .section .level3}
### [](#extension-fenced_code_blocks){.anchor aria-hidden="true"}Extension: `fenced_code_blocks` [±]{.extension-checkbox aria-hidden="true" title="part of commonmark
...
::: {#extension-backtick_code_blocks .section .level3}
### [](#extension-backtick_code_blocks){.anchor aria-hidden="true"}Extension: `backtick_code_blocks` [±]{.extension-checkbox aria-hidden="true" title="part of commonmark
...
::: {#extension-fenced_code_attributes .section .level3}
### [](#extension-fenced_code_attributes){.anchor aria-hidden="true"}Extension: `fenced_code_attributes` [±]{.extension-checkbox aria-hidden="true" title="available in commonmark
      via \"attributes\" extension
...
To prevent all highlighting, use the [`--syntax-highlighting=none`](#option--syntax-highlighting){.option} option. To set the highlighting style or method, use [`--syntax-highlighting`](#option--syntax-highlighting){.option}. For more information on highlighting, see [Syntax highlighting](#syntax-highlighting), below.
:::
::::::::

:::: {#line-blocks .section .level2}
## [](#line-blocks){.anchor aria-hidden="true"}Line blocks

::: {#extension-line_blocks .section .level3}
### [](#extension-line_blocks){.anchor aria-hidden="true"}Extension: `line_blocks` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + html
      + html4
      + html5
      + markdown
...
## [](#lists){.anchor aria-hidden="true"}Lists

::: {#bullet-lists .section .level3}
### [](#bullet-lists){.anchor aria-hidden="true"}Bullet lists
...
::: {#block-content-in-list-items .section .level3}
### [](#block-content-in-list-items){.anchor aria-hidden="true"}Block content in list items
...
### [](#ordered-lists){.anchor aria-hidden="true"}Ordered lists
...
::: {#extension-fancy_lists .section .level3}
### [](#extension-fancy_lists){.anchor aria-hidden="true"}Extension: `fancy_lists` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + markdown
      + opml
      + plain
...
::: {#extension-startnum .section .level3}
### [](#extension-startnum){.anchor aria-hidden="true"}Extension: `startnum` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
      + plain
...
::: {#extension-task_lists .section .level3}
### [](#extension-task_lists){.anchor aria-hidden="true"}Extension: `task_lists` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + gfm
      + ipynb
      + markdown
...
### [](#definition-lists){.anchor aria-hidden="true"}Definition lists
:::

::: {#extension-definition_lists .section .level3}
### [](#extension-definition_lists){.anchor aria-hidden="true"}Extension: `definition_lists` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + markdown
      + markdown_mmd
      + markdown_phpextra
...
Pandoc supports definition lists, using the syntax of [PHP Markdown Extra](https://michelf.ca/projects/php-markdown/extra/) with some extensions.[^2^](#fn2){#fnref2 .footnote-ref role="doc-noteref"}
...
::: {#numbered-example-lists .section .level3}
### [](#numbered-example-lists){.anchor aria-hidden="true"}Numbered example lists
:::

::: {#extension-example_lists .section .level3}
### [](#extension-example_lists){.anchor aria-hidden="true"}Extension: `example_lists` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
      + plain
...
::: {#ending-a-list .section .level3}
### [](#ending-a-list){.anchor aria-hidden="true"}Ending a list
...
## [](#horizontal-rules){.anchor aria-hidden="true"}Horizontal rules
...
::::::::: {#tables .section .level2}
## [](#tables){.anchor aria-hidden="true"}Tables
...
::: {#extension-table_captions .section .level3}
### [](#extension-table_captions){.anchor aria-hidden="true"}Extension: `table_captions` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
      + plain
...
::: {#extension-simple_tables .section .level3}
### [](#extension-simple_tables){.anchor aria-hidden="true"}Extension: `simple_tables` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
      + plain
...
The header and table rows must each fit on one line. Column alignments are determined by the position of the header text relative to the dashed line below it:[^3^](#fn3){#fnref3 .footnote-ref role="doc-noteref"}
...
::: {#extension-multiline_tables .section .level3}
### [](#extension-multiline_tables){.anchor aria-hidden="true"}Extension: `multiline_tables` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
      + plain
...
::: {#extension-grid_tables .section .level3}
### [](#extension-grid_tables){.anchor aria-hidden="true"}Extension: `grid_tables` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
      + plain
...
::: {#extension-pipe_tables .section .level3}
### [](#extension-pipe_tables){.anchor aria-hidden="true"}Extension: `pipe_tables` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + gfm
      + ipynb
      + markdown
...
::: {#extension-table_attributes .section .level3}
### [](#extension-table_attributes){.anchor aria-hidden="true"}Extension: `table_attributes` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
...
Attributes may be attached to tables by including them at the end of the caption. (For the syntax, see [`header_attributes`](#extension-header_attributes).)

      : Here's the caption. {#ident .class key="value"}
:::
:::::::::

::::: {#metadata-blocks .section .level2}
## [](#metadata-blocks){.anchor aria-hidden="true"}Metadata blocks

::: {#extension-pandoc_title_block .section .level3}
### [](#extension-pandoc_title_block){.anchor aria-hidden="true"}Extension: `pandoc_title_block` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
...
Title blocks will always be parsed, but they will affect the output only when the [`--standalone`](#option--standalone){.option} ([`-s`](#option--standalone){.option}) option is chosen. In HTML output, titles will appear twice: once in the document head---this is the title that will appear at the top of the window in a browser---and once at the beginning of the document body. The title in the document head can have an optional prefix attached ([`--title-prefix`](#option--title-prefix){.option} or [`-T`](#option--title-prefix){.option} option). The title in the body appears as an H1 element with class "title", so it can be suppressed or reformatted with CSS. If a title prefix is specified with [`-T`](#option--title-prefix){.option} and no title block appears in the document, the title prefix will be used by itself as the HTML title.
...
::: {#extension-yaml_metadata_block .section .level3}
### [](#extension-yaml_metadata_block){.anchor aria-hidden="true"}Extension: `yaml_metadata_block` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + gfm
      + markdown
      + opml
...
Just be sure that the YAML file begins with `---` and ends with `---` or `...`. Alternatively, you can use the [`--metadata-file`](#option--metadata-file){.option} option. Using that approach however, you cannot reference content (like footnotes) from the main Markdown input document.
...
When pandoc is used with [`-t markdown`](#option--to){.option} to create a Markdown document, a YAML metadata block will be produced only if the [`-s/--standalone`](#option--standalone){.option} option is used. All of the metadata will appear in a single block at the beginning of the document.
...
:::: {#backslash-escapes .section .level2}
## [](#backslash-escapes){.anchor aria-hidden="true"}Backslash escapes

::: {#extension-all_symbols_escapable .section .level3}
### [](#extension-all_symbols_escapable){.anchor aria-hidden="true"}Extension: `all_symbols_escapable` [±]{.extension-checkbox aria-hidden="true" title="part of commonmark
...
:::::::::::::: {#inline-formatting .section .level2}
## [](#inline-formatting){.anchor aria-hidden="true"}Inline formatting

::: {#emphasis .section .level3}
### [](#emphasis){.anchor aria-hidden="true"}Emphasis
...
::: {#extension-intraword_underscores .section .level3}
### [](#extension-intraword_underscores){.anchor aria-hidden="true"}Extension: `intraword_underscores` [±]{.extension-checkbox aria-hidden="true" title="part of commonmark
...
::: {#strikeout .section .level3}
### [](#strikeout){.anchor aria-hidden="true"}Strikeout
:::

::: {#extension-strikeout .section .level3}
### [](#extension-strikeout){.anchor aria-hidden="true"}Extension: `strikeout` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + gfm
      + ipynb
      + markdown
...
::: {#superscripts-and-subscripts .section .level3}
### [](#superscripts-and-subscripts){.anchor aria-hidden="true"}Superscripts and subscripts
:::

::: {#extension-superscript-subscript .section .level3}
### [](#extension-superscript-subscript){.anchor aria-hidden="true"}Extension: `superscript`, `subscript` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + markdown
      + markdown_mmd
      + opml
...
::: {#verbatim .section .level3}
### [](#verbatim){.anchor aria-hidden="true"}Verbatim
...
::: {#extension-inline_code_attributes .section .level3}
### [](#extension-inline_code_attributes){.anchor aria-hidden="true"}Extension: `inline_code_attributes` [±]{.extension-checkbox aria-hidden="true" title="available in commonmark
      via \"attributes\" extension
...
::: {#underline .section .level3}
### [](#underline){.anchor aria-hidden="true"}Underline
...
::: {#small-caps .section .level3}
### [](#small-caps){.anchor aria-hidden="true"}Small caps
...
::: {#highlighting .section .level3}
### [](#highlighting){.anchor aria-hidden="true"}Highlighting
...
:::: {#math .section .level2}
## [](#math){.anchor aria-hidden="true"}Math

::: {#extension-tex_math_dollars .section .level3}
### [](#extension-tex_math_dollars){.anchor aria-hidden="true"}Extension: `tex_math_dollars` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + gfm
      + ipynb
      + markdown
...
DocBook
:   If the [`--mathml`](#option--mathml){.option} flag is used, it will be rendered using MathML in an `inlineequation` or `informalequation` tag. Otherwise it will be rendered, if possible, using Unicode characters.

Docx and PowerPoint
:   It will be rendered using OMML math markup.

FictionBook2
:   If the [`--webtex`](#option--webtex){.option} option is used, formulas are rendered as images using CodeCogs or other compatible web service, downloaded and embedded in the e-book. Otherwise, they will appear verbatim.
...
:::::::::: {#raw-html .section .level2}
## [](#raw-html){.anchor aria-hidden="true"}Raw HTML

::: {#extension-raw_html .section .level3}
### [](#extension-raw_html){.anchor aria-hidden="true"}Extension: `raw_html` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark
      + commonmark_x
      + epub
      + epub2
...
For a more explicit way of including raw HTML in a Markdown document, see the [`raw_attribute` extension](#extension-raw_attribute).
...
::: {#extension-markdown_in_html_blocks .section .level3}
### [](#extension-markdown_in_html_blocks){.anchor aria-hidden="true"}Extension: `markdown_in_html_blocks` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
...
::: {#extension-native_divs .section .level3}
### [](#extension-native_divs){.anchor aria-hidden="true"}Extension: `native_divs` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + epub
      + epub2
      + epub3
      + html
...
::: {#extension-native_spans .section .level3}
### [](#extension-native_spans){.anchor aria-hidden="true"}Extension: `native_spans` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + epub
      + epub2
      + epub3
      + html
...
::: {#extension-raw_tex .section .level3}
### [](#extension-raw_tex){.anchor aria-hidden="true"}Extension: `raw_tex` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
...
For a more explicit and flexible way of including raw TeX in a Markdown document, see the [`raw_attribute` extension](#extension-raw_attribute).

Inline LaTeX is ignored in output formats other than Markdown, LaTeX, Emacs Org mode, and ConTeXt.
:::

::: {#generic-raw-attribute .section .level3}
### [](#generic-raw-attribute){.anchor aria-hidden="true"}Generic raw attribute
:::

::: {#extension-raw_attribute .section .level3}
### [](#extension-raw_attribute){.anchor aria-hidden="true"}Extension: `raw_attribute` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + markdown
      + markdown_mmd
      + opml
...
The format name should match the target format name (see [`-t/--to`](#option--to){.option}, above, for a list, or use `pandoc --list-output-formats`). Use `openxml` for `docx` output, `opendocument` for `odt` output, `html5` for `epub3` output, `html4` for `epub2` output, and `latex`, `beamer`, `ms`, or `html5` for `pdf` output (depending on what you use for [`--pdf-engine`](#option--pdf-engine){.option}).
...
:::: {#latex-macros .section .level2}
## [](#latex-macros){.anchor aria-hidden="true"}LaTeX macros

::: {#extension-latex_macros .section .level3}
### [](#extension-latex_macros){.anchor aria-hidden="true"}Extension: `latex_macros` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + beamer
      + latex
      + markdown
      + opml
...
Note that LaTeX macros will not be applied if they occur inside a raw span or block marked with the [`raw_attribute` extension](#extension-raw_attribute).
...
:::::::: {#links-1 .section .level2}
## [](#links-1){.anchor aria-hidden="true"}Links

Markdown allows links to be specified in several ways.

::: {#automatic-links .section .level3}
### [](#automatic-links){.anchor aria-hidden="true"}Automatic links
...
::: {#inline-links .section .level3}
### [](#inline-links){.anchor aria-hidden="true"}Inline links
...
::: {#reference-links .section .level3}
### [](#reference-links){.anchor aria-hidden="true"}Reference links
...
::: {#extension-shortcut_reference_links .section .level3}
### [](#extension-shortcut_reference_links){.anchor aria-hidden="true"}Extension: `shortcut_reference_links` [±]{.extension-checkbox aria-hidden="true" title="part of commonmark
...
::: {#internal-links .section .level3}
### [](#internal-links){.anchor aria-hidden="true"}Internal links
...
::::: {#images .section .level2}
## [](#images){.anchor aria-hidden="true"}Images
...
::: {#extension-implicit_figures .section .level3}
### [](#extension-implicit_figures){.anchor aria-hidden="true"}Extension: `implicit_figures` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + markdown_mmd
      + opml
      + plain
...
::: {#extension-link_attributes .section .level3}
### [](#extension-link_attributes){.anchor aria-hidden="true"}Extension: `link_attributes` [±]{.extension-checkbox aria-hidden="true" title="available in commonmark
      via \"attributes\" extension
...
::::: {#divs-and-spans .section .level2}
## [](#divs-and-spans){.anchor aria-hidden="true"}Divs and Spans

Using the `native_divs` and `native_spans` extensions (see [above](#extension-native_divs)), HTML syntax can be used as part of Markdown to create native `Div` and `Span` elements in the pandoc AST (as opposed to raw HTML). However, there is also nicer syntax available:

::: {#extension-fenced_divs .section .level3}
### [](#extension-fenced_divs){.anchor aria-hidden="true"}Extension: `fenced_divs` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + markdown
      + opml
...
The attribute syntax is exactly as in fenced code blocks (see [Extension: `fenced_code_attributes`](#extension-fenced_code_attributes)). As with fenced code blocks, one can use either attributes in curly braces or a single unbraced word, which will be treated as a class name. The Div ends with another line containing a string of at least three consecutive colons. The fenced Div should be separated by blank lines from preceding and following blocks.
...
::: {#extension-bracketed_spans .section .level3}
### [](#extension-bracketed_spans){.anchor aria-hidden="true"}Extension: `bracketed_spans` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + markdown
      + opml
...
## [](#footnotes){.anchor aria-hidden="true"}Footnotes

::: {#extension-footnotes .section .level3}
### [](#extension-footnotes){.anchor aria-hidden="true"}Extension: `footnotes` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + gfm
      + markdown
      + markdown_github
...
::: {#extension-inline_notes .section .level3}
### [](#extension-inline_notes){.anchor aria-hidden="true"}Extension: `inline_notes` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
...
:::: {#citation-syntax .section .level2}
## [](#citation-syntax){.anchor aria-hidden="true"}Citation syntax

::: {#extension-citations .section .level3}
### [](#extension-citations){.anchor aria-hidden="true"}Extension: `citations` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown
      + opml
      + org
      + typst
...
::::::::::::::::::::::::::::: {#non-default-extensions .section .level2}
## [](#non-default-extensions){.anchor aria-hidden="true"}Non-default extensions
...
::: {#extension-rebase_relative_paths .section .level3}
### [](#extension-rebase_relative_paths){.anchor aria-hidden="true"}Extension: `rebase_relative_paths` [±]{.extension-checkbox aria-hidden="true" title="disabled by default for:
      - commonmark
      - commonmark_x
      - gfm
      - ipynb
...
::: {#extension-mark .section .level3}
### [](#extension-mark){.anchor aria-hidden="true"}Extension: `mark` [±]{.extension-checkbox aria-hidden="true" title="disabled by default for:
      - ipynb
      - markdown
      - markdown_github
      - markdown_mmd
...
::: {#extension-attributes .section .level3}
### [](#extension-attributes){.anchor aria-hidden="true"}Extension: `attributes` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
...
Allows attributes to be attached to any inline or block-level element when parsing `commonmark`. The syntax for the attributes is the same as that used in [`header_attributes`](#extension-header_attributes).
...
::: {#extension-old_dashes .section .level3}
### [](#extension-old_dashes){.anchor aria-hidden="true"}Extension: `old_dashes` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + textile
...
::: {#extension-angle_brackets_escapable .section .level3}
### [](#extension-angle_brackets_escapable){.anchor aria-hidden="true"}Extension: `angle_brackets_escapable` [±]{.extension-checkbox aria-hidden="true" title="part of commonmark
...
::: {#extension-lists_without_preceding_blankline .section .level3}
### [](#extension-lists_without_preceding_blankline){.anchor aria-hidden="true"}Extension: `lists_without_preceding_blankline` [±]{.extension-checkbox aria-hidden="true" title="part of commonmark
...
::: {#extension-four_space_rule .section .level3}
### [](#extension-four_space_rule){.anchor aria-hidden="true"}Extension: `four_space_rule` [±]{.extension-checkbox aria-hidden="true" title="disabled by default for:
      - ipynb
      - markdown
      - markdown_github
      - markdown_mmd
...
::: {#extension-spaced_reference_links .section .level3}
### [](#extension-spaced_reference_links){.anchor aria-hidden="true"}Extension: `spaced_reference_links` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown_mmd
      + markdown_phpextra
      + markdown_strict
...
::: {#extension-hard_line_breaks .section .level3}
### [](#extension-hard_line_breaks){.anchor aria-hidden="true"}Extension: `hard_line_breaks` [±]{.extension-checkbox aria-hidden="true" title="disabled by default for:
      - commonmark
      - commonmark_x
      - gfm
      - ipynb
...
::: {#extension-ignore_line_breaks .section .level3}
### [](#extension-ignore_line_breaks){.anchor aria-hidden="true"}Extension: `ignore_line_breaks` [±]{.extension-checkbox aria-hidden="true" title="disabled by default for:
      - ipynb
      - markdown
      - markdown_github
      - markdown_mmd
...
::: {#extension-east_asian_line_breaks .section .level3}
### [](#extension-east_asian_line_breaks){.anchor aria-hidden="true"}Extension: `east_asian_line_breaks` [±]{.extension-checkbox aria-hidden="true" title="disabled by default for:
      - ansi
      - asciidoc
      - asciidoc_legacy
      - asciidoctor
...
::: {#extension-emoji .section .level3}
### [](#extension-emoji){.anchor aria-hidden="true"}Extension: `emoji` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + gfm
      + markdown_github
...
::: {#extension-tex_math_gfm .section .level3}
### [](#extension-tex_math_gfm){.anchor aria-hidden="true"}Extension: `tex_math_gfm` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + gfm
...
::: {#extension-tex_math_single_backslash .section .level3}
### [](#extension-tex_math_single_backslash){.anchor aria-hidden="true"}Extension: `tex_math_single_backslash` [±]{.extension-checkbox aria-hidden="true" title="disabled by default for:
      - epub
      - epub2
      - epub3
      - html
...
::: {#extension-tex_math_double_backslash .section .level3}
### [](#extension-tex_math_double_backslash){.anchor aria-hidden="true"}Extension: `tex_math_double_backslash` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown_mmd
...
::: {#extension-markdown_attribute .section .level3}
### [](#extension-markdown_attribute){.anchor aria-hidden="true"}Extension: `markdown_attribute` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown_mmd
      + markdown_phpextra
...
::: {#extension-mmd_title_block .section .level3}
### [](#extension-mmd_title_block){.anchor aria-hidden="true"}Extension: `mmd_title_block` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown_mmd
...
::: {#extension-abbreviations .section .level3}
### [](#extension-abbreviations){.anchor aria-hidden="true"}Extension: `abbreviations` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown_phpextra
...
::: {#extension-alerts .section .level3}
### [](#extension-alerts){.anchor aria-hidden="true"}Extension: `alerts` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + commonmark_x
      + gfm
...
::: {#extension-autolink_bare_uris .section .level3}
### [](#extension-autolink_bare_uris){.anchor aria-hidden="true"}Extension: `autolink_bare_uris` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + gfm
      + ipynb
      + markdown_github
...
::: {#extension-mmd_link_attributes .section .level3}
### [](#extension-mmd_link_attributes){.anchor aria-hidden="true"}Extension: `mmd_link_attributes` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown_mmd
...
Parses MultiMarkdown-style key-value attributes on link and image references. This extension should not be confused with the [`link_attributes`](#extension-link_attributes) extension.
...
::: {#extension-mmd_header_identifiers .section .level3}
### [](#extension-mmd_header_identifiers){.anchor aria-hidden="true"}Extension: `mmd_header_identifiers` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown_mmd
...
::: {#extension-gutenberg .section .level3}
### [](#extension-gutenberg){.anchor aria-hidden="true"}Extension: `gutenberg` [±]{.extension-checkbox aria-hidden="true" title="disabled by default for:
      - ipynb
      - markdown
      - markdown_github
      - markdown_mmd
...
::: {#extension-sourcepos .section .level3}
### [](#extension-sourcepos){.anchor aria-hidden="true"}Extension: `sourcepos` [±]{.extension-checkbox aria-hidden="true" title="disabled by default for:
      - commonmark
      - commonmark_x
      - djot
      - gfm
...
::: {#extension-short_subsuperscripts .section .level3}
### [](#extension-short_subsuperscripts){.anchor aria-hidden="true"}Extension: `short_subsuperscripts` [±]{.extension-checkbox aria-hidden="true" title="enabled by default for:
      + markdown_mmd
...
::: {#extension-wikilinks_title_after_pipe .section .level3}
### [](#extension-wikilinks_title_after_pipe){.anchor aria-hidden="true"}Extension: `wikilinks_title_after_pipe` [±]{.extension-checkbox aria-hidden="true" title="disabled by default for:
      - commonmark
      - commonmark_x
      - gfm
      - ipynb
...
Using [`--from=markdown+wikilinks_title_after_pipe`](#option--from){.option} results in

``` [[wiki]]
[[URL|title]]
```

while using [`--from=markdown+wikilinks_title_before_pipe`](#option--from){.option} results in
...
::: {#markdown-variants .section .level2}
## [](#markdown-variants){.anchor aria-hidden="true"}Markdown variants
