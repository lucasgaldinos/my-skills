...
argument-hint: 
  - diagram description or requirements
  - mermaid diagrams cited
---
...
1. **Understand Requirements**: Analyze user description to determine the most suitable diagram type, given the context and requirements. Consider factors like the type of information, relationships, and desired insights.
