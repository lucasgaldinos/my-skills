...
description: |
  Use this skill when creating or updating an AGENTS.md file for a repository. Triggers on: "create AGENTS.md", "add an agents file", "help AI agents work on this repo", "write agent instructions for this project", "set up agent context", "create a README for agents", "help Copilot understand this codebase". Produces a complete, actionable AGENTS.md at the repo root following the open agents.md format — covering setup commands, dev workflow, testing, code style, and PR guidelines so any coding agent can contribute effectively without extra guidance.
argument-hint: "[repository path or description of the project]"
user-invocable: true
---
